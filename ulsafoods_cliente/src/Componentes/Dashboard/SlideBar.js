    ...
    return (
        <div className='slidebar'>
            <ul>
                ...
                <li>
                    <NavLink to="/Dashboard/ventas" className='text-light rounded py-2 w-100 d-inline-block px-3' activeclassname='active'><FaIcons.FaCashRegister className='me-2' color="white" /> Clientes</NavLink>
                </li>
                <li>
